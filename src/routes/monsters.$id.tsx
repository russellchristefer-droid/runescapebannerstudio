      ...
      <main className="mx-auto max-w-3xl px-5 py-6 md:px-8">
        ...
        {src ? (
          <StillPhoto
            ...
            className="aspect-[21/9] w-full border border-[#39ff6a] bg-surface object-cover"
            style={{ boxShadow: `inset 0 3px 0 0 ${monsterWash(row)}` }}
          />
        ) : (
          <p className="border border-[#39ff6a] bg-surface px-3 py-10 text-center text-sm text-muted">Even the beast declined to appear.</p>
        )}
