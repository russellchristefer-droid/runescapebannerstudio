...
function doorInk(label: string) {
  ...
  if (t.includes("rated") || t.includes("gold") || t.includes("exit")) return "#2db85a";
  return "#2db85a";
}
  ...
  return (
    <div className="mt-4 flex snap-x snap-mandatory gap-3 overflow-x-auto pb-2">
      {items.map((item) => (
        ...
        >
          <div className="h-0.5 bg-[#2db85a]" aria-hidden="true" />
          ...
          <figcaption className="px-2 py-1.5 text-[11px] tracking-[0.08em] text-[#2db85a] uppercase">{item.name}</figcaption>
        </figure>
      ))}
    </div>
  );
    ...
    <div className="mt-4 grid grid-cols-2 gap-3 md:grid-cols-3">
      {items.map((item) => (
        ...
        >
          ...
          <figcaption className="border-t border-[#2db85a]/20 px-2 py-1.5">
            <p className="text-[12px] text-[#efe4c8]">{item.name}</p>
            {item.era ? (
              <p className="text-[11px] tracking-[0.12em] text-[#2db85a] uppercase">{item.era}</p>
            ) : null}
...
function RoomDeck({
  ...
  const n = srcs.length;
  return (
    <figure className="overflow-hidden rounded-md border border-[#2db85a]/70 bg-[#120e0a] shadow-[inset_0_0_0_1px_rgba(198,164,90,0.15)]">
      <div className="h-0.5 bg-[#2db85a]" aria-hidden="true" />
      <div className="relative flex min-h-[280px] items-center justify-center bg-[#0c0a08] md:min-h-[340px]">
        ...
        {n > 1 ? (
          <>
            <button
              type="button"
              className="absolute left-2 top-1/2 min-h-11 min-w-11 -translate-y-1/2 rounded-md border border-[#2db85a]/60 bg-[#120e0a]/80 text-[#efe4c8]"
            ...
            <button
              type="button"
              className="absolute right-2 top-1/2 min-h-11 min-w-11 -translate-y-1/2 rounded-md border border-[#2db85a]/60 bg-[#120e0a]/80 text-[#efe4c8]"
      ...
      <figcaption className="border-t border-[#2db85a]/25 px-3 py-2">
        <p className="text-sm text-[#efe4c8]">{place}</p>
        <p className="text-[11px] tracking-[0.12em] text-[#2db85a] uppercase">{era}</p>
  ...
  return (
    <div className="min-h-dvh bg-bg text-fg">
      <header className="border-b border-line px-5 py-5 md:px-8">
        ...
        <p className="mt-2 mx-auto max-w-2xl text-center text-[11px] tracking-[0.22em] text-[#2db85a] uppercase">
          The hall
        </p>
      ...
      <main className="mx-auto flex max-w-5xl flex-col gap-8 px-5 py-6 md:px-8">
        ...
        <section>
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">4 January 2001 — fight almost anywhere</h3>
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">13 August 2001 — the ditch is born</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">13 December 2004 — the flag</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">19 September 2005 — the pit</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">18 April 2007 — the ditch you have to confirm</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">10 December 2007 — the law breaks and the room is named</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">9 September 2008 — white and red</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">2008–2009 — PvP worlds and bounty worlds</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">Winter 2010 — the vote</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">1 February 2011 — the wild comes home, the hall leaves</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">22 February 2013 — two grammars</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">19 June 2014 — Old School names the room</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">The main client after the split</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">16 July 2020 — Ferox</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">23 May 2024 — Classic F2P magic</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">13 November 2024 — blighted in the pocket</h3>
          <p className="text-sm leading-relaxed text-muted">
            Blighted supplies may be eaten inside Ferox. The pocket is still a pocket.
            The ditch outside is still the tax.
          </p>

          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">2025 — Bounty Hunter is a crater</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">28 January 2026 — Oddskull still a mode</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">27 May 2026 — thirty seconds</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">The current hour</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">How the piles actually worked</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">The ditch after the portal</h3>
          <p className="text-sm leading-relaxed text-muted">
        ...
        <section>
          ...
          <h3 className="mt-4 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">Old School — Mor Ul Rek</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-4 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">RuneScape — TzHaar City</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-4 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">How the pit is won</h3>
        ...
        <section id="win" className="scroll-mt-20">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">The terms — the actual fight</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">Old School — Ferox</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">RuneScape — Grotto</h3>
          <p className="text-sm leading-relaxed text-muted">
          ...
          <h3 className="mt-5 mb-1 text-sm tracking-[0.14em] text-[#2db85a] uppercase">How to not donate the hour</h3>
          <ol className="mt-3 space-y-2 text-sm text-muted">
