...
const ROOMS = [
  ...
  },
  {
    place: "Ferox Enclave",
    era: "Old School",
    note: "The house in the wild. People walk the square.",
    srcs: ["/clan-wars/osrs-ferox.png"],
  },
  {
    place: "Yanille",
    era: "Old School",
    note: "West of here is the Castle Wars door.",
    srcs: [
      "/locations/yanille.jpg",
      "/locations/ardougne.jpg",
    ],
  },
  {
    place: "Gamers' Grotto",
    era: "RuneScape",
    note: "The cave north of Falador.",
    srcs: [
  ...
  },
  {
    place: "Falador",
    era: "RuneScape",
    note: "White walls. The Grotto is north.",
    srcs: [
