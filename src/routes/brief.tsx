...
function BriefPage() {
  return (
    <div className="min-h-dvh bg-bg text-fg">
      ...
      <main
        id="content"
        className="prose-desk mx-auto mt-6 mb-8 flex max-w-[42rem] flex-col gap-6 border border-[#c4a35a] bg-[#0b0b0b] px-5 py-8 text-sm leading-[1.55] text-muted md:px-9"
      ...
      >
        ...
        <section>
          ...
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              <In to="/edit">Clip Editor</In> — the other half of Banner Studio. Local video: Upload a clip you own, mark In / Out, mute, gain, fades, Save an MP4. Desk banner (from Save for clips on the home desk) sits top or bottom. The clip stays on this device. It does not go live.
            </li>
            <li>
