...
function BriefPage() {
  return (
    <div className="min-h-dvh bg-bg text-fg">
      ...
      <main
        id="content"
        className="prose-desk mx-auto mt-6 mb-8 flex max-w-[42rem] flex-col gap-6 border border-[#e6d000] bg-[#0b0b0b] px-5 py-8 text-sm leading-[1.55] text-muted md:px-9"
