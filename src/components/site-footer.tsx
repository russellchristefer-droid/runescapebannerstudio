...
export function SiteFooter() {
  return (
    <footer className="mx-2 mb-2 mt-4 border px-3 py-4 text-[11px] leading-relaxed text-faint md:px-8" style={{ borderColor: "color-mix(in srgb, #c4a35a 60%, transparent)" }}>
