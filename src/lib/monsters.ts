...
const MONSTER_LINE: Record<string, string> = {
  ...
  "rs3-muspah": "They change style. The ritual site is the room.",
  "rs3-nihil": "Four faces. Name the one on the assignment.",
  "rs3-frostdragon": "Bones and antifire. Resource dungeon.",
  ...
  "rs3-mutatedjadinko": "Three sizes in the lair.",
  "rs3-seeker": "Stalker dungeon. Soulgazer is next.",
  "rs3-soulgazer": "Heavier seeker. Same dungeon.",
  "rs3-acheronmammoth": "They knock. The iceberg is the room.",
  "rs3-crystalshapeshifter": "Match the form. Tarddiad.",
  "rs3-vyrewatch": "Blisterwood. Darkmeyer street.",
  "rs3-dagannoth": "The shore task. Kings on Bosses.",
  "rs3-dustdevil": "Mask. Smoke Dungeon.",
  "rs3-spiritualwarrior": "Kill count. Not a commander.",
  "rs3-corruptedworker": "Sophanem work. Raid stays on Bosses.",
  "rs3-nightspider": "Polypore lane.",
  "rs3-rorarius": "Ascension floor. Legiones on Bosses.",
  "rs3-gladius": "Heavier than a rorarius. Keystones, not a legion.",
  "rs3-capsarius": "They heal the room. Kill the healer first.",
  ...
  "rs3-abyssalsavage": "Heavier abyssal. They teleport.",
  "rs3-abyssallord": "The late abyssal. No barrage paragraph.",
  "rs3-brutishdino": "Anachronia. Heavy melee.",
  "rs3-feraldino": "The island pack. Learn the click.",
  "rs3-venomdino": "Poison on Anachronia. Sip first.",
  "rs3-mutatedbloodveld": "The later bloodveld. The lab is the room.",
  "rs3-tormenteddemon": "They swap prayer. Match the style.",
  ...
  "osrs-ankou": "Sepulchre of Death. Catacombs is the other room.",
  "osrs-minotaur": "Vault of War. First floor.",
  "osrs-wolf": "Vault of War pack.",
  "osrs-rat": "Floor fodder. Then leave.",
  "osrs-giantrat": "Catacomb of Famine.",
  "osrs-fleshcrawler": "Second floor. They hit more than they look.",
  "osrs-zombie": "Second floor. Crumble if you have it.",
  "osrs-catablepon": "They drain Strength. That is the wipe.",
  "osrs-spider": "Pit of Pestilence fodder.",
  "osrs-giantspider": "Third floor. Confirm poison.",
  "osrs-scorpion": "Third floor. Not a pit scorpion.",
  "osrs-ghost": "Sepulchre. Salve if you have it.",
  "osrs-shade": "Fourth floor. Not Mort’ton.",
  "osrs-skeleton": "Fourth floor. Crush.",
  "rs3-ankou": "Sepulchre of Death. Play the bar.",
  "rs3-minotaur": "Vault of War. First floor.",
  "rs3-wolf": "Vault of War pack.",
  "rs3-rat": "Floor fodder. Then leave.",
  "rs3-giantrat": "Catacomb of Famine.",
  "rs3-fleshcrawler": "Second floor. They hit more than they look.",
  "rs3-zombie": "Second floor. Play the bar.",
  "rs3-catablepon": "They drain Strength. That is the wipe.",
  "rs3-spider": "Pit of Pestilence fodder.",
  "rs3-giantspider": "Third floor.",
  "rs3-scorpion": "Third floor. Not a pit scorpion.",
  "rs3-ghost": "Sepulchre. Salve if you have it.",
  "rs3-shade": "Fourth floor. Not Mort’ton.",
  "rs3-skeleton": "Fourth floor. Crush.",
...
export const MONSTERS: Monster[] = [
  ...
  { id: "osrs-ankou", slug: "ankou", name: "Ankou", edition: "OSRS", kind: "monster", slayer: true, where: "Stronghold of Security, Catacombs", hunt: "Sepulchre of Death and the Catacombs. Melee. Stronghold is single. Catacombs is the burst room. Leave a raid title home.", wiki: osrsWiki("Ankou"), still: "", placeId: "osrsvarrock" },
  { id: "osrs-minotaur", slug: "minotaur", name: "Minotaur", edition: "OSRS", kind: "monster", slayer: true, where: "Stronghold of Security — Vault of War", hunt: "First floor. Melee. The strongbox is upstairs. Learn the click.", wiki: osrsWiki("Minotaur"), still: "" },
  { id: "osrs-wolf", slug: "wolf", name: "Wolf", edition: "OSRS", kind: "monster", slayer: true, where: "Stronghold of Security — Vault of War", hunt: "First floor pack. Melee. White wolves are a different hill.", wiki: osrsWiki("Wolf"), still: "" },
  { id: "osrs-rat", slug: "rat", name: "Rat", edition: "OSRS", kind: "monster", where: "Stronghold of Security", hunt: "Floor fodder. Learn food, then leave.", wiki: osrsWiki("Rat"), still: "" },
  { id: "osrs-giantrat", slug: "giant-rat", name: "Giant rat", edition: "OSRS", kind: "monster", slayer: true, where: "Stronghold of Security — Catacomb of Famine", hunt: "Second floor. Melee. Lumbridge sewers are the other room.", wiki: osrsWiki("Giant_rat"), still: "" },
  { id: "osrs-fleshcrawler", slug: "flesh-crawler", name: "Flesh crawler", edition: "OSRS", kind: "monster", slayer: true, where: "Stronghold of Security — Catacomb of Famine", hunt: "Second floor. Fast melee. They hit more than they look.", wiki: osrsWiki("Flesh_Crawler"), still: "" },
  { id: "osrs-zombie", slug: "zombie", name: "Zombie", edition: "OSRS", kind: "monster", slayer: true, where: "Stronghold of Security — Catacomb of Famine", hunt: "Second floor and a late shade-floor variant. Melee. Crumble Undead if you have it.", wiki: osrsWiki("Zombie"), still: "" },
  { id: "osrs-catablepon", slug: "catablepon", name: "Catablepon", edition: "OSRS", kind: "monster", slayer: true, where: "Stronghold of Security — Pit of Pestilence", hunt: "Third floor. They drain Strength. Protect as the page says. That is the wipe.", wiki: osrsWiki("Catablepon"), still: "" },
  { id: "osrs-spider", slug: "spider", name: "Spider", edition: "OSRS", kind: "monster", where: "Stronghold of Security — Pit of Pestilence", hunt: "Third floor fodder. Then the giant ones.", wiki: osrsWiki("Spider"), still: "" },
  { id: "osrs-giantspider", slug: "giant-spider", name: "Giant spider", edition: "OSRS", kind: "monster", slayer: true, where: "Stronghold of Security — Pit of Pestilence", hunt: "Third floor. Melee. Poison on some variants — confirm the page.", wiki: osrsWiki("Giant_spider"), still: "" },
  { id: "osrs-scorpion", slug: "scorpion", name: "Scorpion", edition: "OSRS", kind: "monster", slayer: true, where: "Stronghold of Security — Pit of Pestilence", hunt: "Third floor. Poison. Antipoison before the first hit. Pit scorpions under the Legends’ Guild are a different file.", wiki: osrsWiki("Scorpion"), still: "" },
  { id: "osrs-ghost", slug: "ghost", name: "Ghost", edition: "OSRS", kind: "monster", slayer: true, where: "Stronghold of Security — Sepulchre of Death", hunt: "Fourth floor. Salve if you have it. Crumble Undead.", wiki: osrsWiki("Ghost"), still: "" },
  { id: "osrs-shade", slug: "shade", name: "Shade", edition: "OSRS", kind: "monster", slayer: true, where: "Stronghold of Security — Sepulchre of Death", hunt: "Fourth floor. Heavy for the room. Not a Mort’ton shade.", wiki: osrsWiki("Shade"), still: "" },
  { id: "osrs-skeleton", slug: "skeleton", name: "Skeleton", edition: "OSRS", kind: "monster", slayer: true, where: "Stronghold of Security — Sepulchre of Death", hunt: "Fourth floor. Crush. Crumble Undead if you have it.", wiki: osrsWiki("Skeleton"), still: "" },
  ...
  { id: "rs3-muspah", slug: "muspah", name: "Muspah", edition: "RS3", kind: "monster", slayer: true, where: "Mahjarrat Ritual Site", gate: "Slayer", hunt: "RuneScape-only. They change style. Play the bar. The live page owns the hour.", wiki: rs3Wiki("Muspah"), still: "", placeId: "senntisten" },
  { id: "rs3-nihil", slug: "nihil", name: "Nihil", edition: "RS3", kind: "monster", slayer: true, where: "Freneskae", gate: "Slayer", hunt: "Four faces. Pick the one the assignment named. Leave a world-boss title home.", wiki: rs3Wiki("Nihil"), still: "" },
  { id: "rs3-frostdragon", slug: "frost-dragon", name: "Frost dragon", edition: "RS3", kind: "monster", slayer: true, where: "Asgarnian Ice Dungeon resource dungeon", hunt: "Antifire and prayer. Bones are the reason people camp. Confirm the resource dungeon.", wiki: rs3Wiki("Frost_dragon"), still: "" },
  ...
  { id: "rs3-mutatedjadinko", slug: "mutated-jadinko", name: "Mutated jadinko", edition: "RS3", kind: "monster", slayer: true, where: "Jadinko lair", gate: "Slayer", hunt: "Three sizes. Whips if the page still drops them. Confirm the lair.", wiki: rs3Wiki("Mutated_jadinko"), still: "" },
  { id: "rs3-seeker", slug: "seeker", name: "Seeker", edition: "RS3", kind: "monster", slayer: true, where: "Stalker dungeon", gate: "Slayer", hunt: "RuneScape-only. The dungeon is the room. Soulgazer is the next sentence.", wiki: rs3Wiki("Seeker"), still: "" },
  { id: "rs3-soulgazer", slug: "soulgazer", name: "Soulgazer", edition: "RS3", kind: "monster", slayer: true, where: "Stalker dungeon", gate: "Slayer", hunt: "Heavier seeker. Play the bar. Confirm the floor.", wiki: rs3Wiki("Soulgazer"), still: "" },
  { id: "rs3-acheronmammoth", slug: "acheron-mammoth", name: "Acheron mammoth", edition: "RS3", kind: "monster", slayer: true, where: "Iceberg", gate: "Slayer", hunt: "Heavy melee. They knock. The iceberg is the room.", wiki: rs3Wiki("Acheron_mammoth"), still: "" },
  { id: "rs3-crystalshapeshifter", slug: "crystal-shapeshifter", name: "Crystal shapeshifter", edition: "RS3", kind: "monster", slayer: true, where: "Tarddiad", gate: "Slayer", hunt: "They change style. Match the form. Prif is the later city, not this fight.", wiki: rs3Wiki("Crystal_Shapeshifter"), still: "", placeId: "prifddinas" },
  { id: "rs3-vyrewatch", slug: "vyrewatch", name: "Vyrewatch", edition: "RS3", kind: "monster", slayer: true, where: "Darkmeyer, Meiyerditch", hunt: "Blisterwood as the page says. Darkmeyer is the street. Leave a raid title home.", wiki: rs3Wiki("Vyrewatch"), still: "", placeId: "canifis" },
  { id: "rs3-dagannoth", slug: "dagannoth", name: "Dagannoth", edition: "RS3", kind: "monster", slayer: true, where: "Waterbirth, Lighthouse", hunt: "The shore task. Kings stay on Bosses.", wiki: rs3Wiki("Dagannoth"), still: "" },
  { id: "rs3-dustdevil", slug: "dust-devil", name: "Dust devil", edition: "RS3", kind: "monster", slayer: true, where: "Smoke Dungeon", gate: "Slayer — face mask", hunt: "Mask or helm. Smoke Dungeon is hot. Confirm the live page.", wiki: rs3Wiki("Dust_devil"), still: "" },
  { id: "rs3-spiritualwarrior", slug: "spiritual-warrior", name: "Spiritual warrior", edition: "RS3", kind: "monster", slayer: true, where: "God Wars Dungeon", hunt: "Kill count. Not a commander. Bandos room is one door.", wiki: rs3Wiki("Spiritual_warrior"), still: "" },
  { id: "rs3-corruptedworker", slug: "corrupted-worker", name: "Corrupted worker", edition: "RS3", kind: "monster", slayer: true, where: "Sophia’s dungeon lane", gate: "Slayer", hunt: "Menaphos / Sophanem work. Confirm the live name. Amascut’s raid stays on Bosses.", wiki: rs3Wiki("Corrupted_worker"), still: "", placeId: "sophanem" },
  { id: "rs3-nightspider", slug: "night-spider", name: "Night spider", edition: "RS3", kind: "monster", slayer: true, where: "Polypore Dungeon", hunt: "The polypore lane. Ganodermic is the heavier sentence.", wiki: rs3Wiki("Night_spider"), still: "" },
  { id: "rs3-rorarius", slug: "rorarius", name: "Rorarius", edition: "RS3", kind: "monster", slayer: true, where: "Monastery of Ascension", gate: "Slayer", hunt: "Order of Ascension. Keystones on the wiki. Legiones stay on Bosses.", wiki: rs3Wiki("Rorarius"), still: "" },
  { id: "rs3-gladius", slug: "gladius", name: "Gladius", edition: "RS3", kind: "monster", slayer: true, where: "Monastery of Ascension", gate: "Slayer", hunt: "Heavier than a rorarius. Keystones still drop. Legiones stay on Bosses.", wiki: rs3Wiki("Gladius"), still: "" },
  { id: "rs3-capsarius", slug: "capsarius", name: "Capsarius", edition: "RS3", kind: "monster", slayer: true, where: "Monastery of Ascension", gate: "Slayer", hunt: "They heal the room. Kill the healer first or the pull resets. Legiones stay on Bosses.", wiki: rs3Wiki("Capsarius"), still: "" },
  ...
  { id: "rs3-abyssalsavage", slug: "abyssal-savage", name: "Abyssal savage", edition: "RS3", kind: "monster", slayer: true, where: "Abyssal Area", gate: "Slayer", hunt: "Heavier abyssal. They teleport. Play the bar. Lords are the next sentence.", wiki: rs3Wiki("Abyssal_savage"), still: "" },
  { id: "rs3-abyssallord", slug: "abyssal-lord", name: "Abyssal lord", edition: "RS3", kind: "monster", slayer: true, where: "Abyssal Area", gate: "Slayer", hunt: "The late abyssal. Confirm the floor. Do not paste an Old School barrage paragraph here.", wiki: rs3Wiki("Abyssal_lord"), still: "" },
  { id: "rs3-brutishdino", slug: "brutish-dinosaur", name: "Brutish dinosaur", edition: "RS3", kind: "monster", slayer: true, where: "Anachronia", hunt: "Anachronia slayer. Heavy melee. The island is the room. Confirm the live page.", wiki: rs3Wiki("Brutish_dinosaur"), still: "", placeId: "anachronia" },
  { id: "rs3-feraldino", slug: "feral-dinosaur", name: "Feral dinosaur", edition: "RS3", kind: "monster", slayer: true, where: "Anachronia", hunt: "The common island pack. Learn the click. Then leave.", wiki: rs3Wiki("Feral_dinosaur"), still: "", placeId: "anachronia" },
  { id: "rs3-venomdino", slug: "venomous-dinosaur", name: "Venomous dinosaur", edition: "RS3", kind: "monster", slayer: true, where: "Anachronia", hunt: "Poison on the island. Antipoison before the first hit. Confirm the live page.", wiki: rs3Wiki("Venomous_dinosaur"), still: "", placeId: "anachronia" },
  { id: "rs3-mutatedbloodveld", slug: "mutated-bloodveld", name: "Mutated bloodveld", edition: "RS3", kind: "monster", slayer: true, where: "Meiyerditch Laboratories", hunt: "The later bloodveld. Play the bar. Confirm the lab on the wiki.", wiki: rs3Wiki("Mutated_bloodveld"), still: "", placeId: "canifis" },
  { id: "rs3-tormenteddemon", slug: "tormented-demon", name: "Tormented demon", edition: "RS3", kind: "monster", slayer: true, where: "Ghorrock / Ancient Guthix Temple", hunt: "They swap prayer. Match the style. Not a world boss. Confirm the live cave.", wiki: rs3Wiki("Tormented_demon"), still: "" },
  ...
  { id: "rs3-ankou", slug: "ankou", name: "Ankou", edition: "RS3", kind: "monster", slayer: true, where: "Stronghold of Security — Sepulchre of Death", hunt: "Fourth floor. Melee. Play the bar. Leave a raid title home.", wiki: rs3Wiki("Ankou"), still: "" },
  { id: "rs3-minotaur", slug: "minotaur", name: "Minotaur", edition: "RS3", kind: "monster", slayer: true, where: "Stronghold of Security — Vault of War", hunt: "First floor. Melee. The strongbox is upstairs.", wiki: rs3Wiki("Minotaur"), still: "" },
  { id: "rs3-wolf", slug: "wolf", name: "Wolf", edition: "RS3", kind: "monster", slayer: true, where: "Stronghold of Security — Vault of War", hunt: "First floor pack. Melee. White wolves are a different hill.", wiki: rs3Wiki("Wolf"), still: "" },
  { id: "rs3-rat", slug: "rat", name: "Rat", edition: "RS3", kind: "monster", where: "Stronghold of Security", hunt: "Floor fodder. Learn the click, then leave.", wiki: rs3Wiki("Rat"), still: "" },
  { id: "rs3-giantrat", slug: "giant-rat", name: "Giant rat", edition: "RS3", kind: "monster", slayer: true, where: "Stronghold of Security — Catacomb of Famine", hunt: "Second floor. Melee.", wiki: rs3Wiki("Giant_rat"), still: "" },
  { id: "rs3-fleshcrawler", slug: "flesh-crawler", name: "Flesh crawler", edition: "RS3", kind: "monster", slayer: true, where: "Stronghold of Security — Catacomb of Famine", hunt: "Second floor. Fast melee. They hit more than they look.", wiki: rs3Wiki("Flesh_Crawler"), still: "" },
  { id: "rs3-zombie", slug: "zombie", name: "Zombie", edition: "RS3", kind: "monster", slayer: true, where: "Stronghold of Security — Catacomb of Famine", hunt: "Second floor. Melee. Play the bar.", wiki: rs3Wiki("Zombie"), still: "" },
  { id: "rs3-catablepon", slug: "catablepon", name: "Catablepon", edition: "RS3", kind: "monster", slayer: true, where: "Stronghold of Security — Pit of Pestilence", hunt: "Third floor. They drain Strength. That is the wipe.", wiki: rs3Wiki("Catablepon"), still: "" },
  { id: "rs3-spider", slug: "spider", name: "Spider", edition: "RS3", kind: "monster", where: "Stronghold of Security — Pit of Pestilence", hunt: "Third floor fodder. Then the giant ones.", wiki: rs3Wiki("Spider"), still: "" },
  { id: "rs3-giantspider", slug: "giant-spider", name: "Giant spider", edition: "RS3", kind: "monster", slayer: true, where: "Stronghold of Security — Pit of Pestilence", hunt: "Third floor. Melee.", wiki: rs3Wiki("Giant_spider"), still: "" },
  { id: "rs3-scorpion", slug: "scorpion", name: "Scorpion", edition: "RS3", kind: "monster", slayer: true, where: "Stronghold of Security — Pit of Pestilence", hunt: "Third floor. Poison. Pit scorpions under the Legends’ Guild are a different file.", wiki: rs3Wiki("Scorpion"), still: "" },
  { id: "rs3-ghost", slug: "ghost", name: "Ghost", edition: "RS3", kind: "monster", slayer: true, where: "Stronghold of Security — Sepulchre of Death", hunt: "Fourth floor. Salve if you have it.", wiki: rs3Wiki("Ghost"), still: "" },
  { id: "rs3-shade", slug: "shade", name: "Shade", edition: "RS3", kind: "monster", slayer: true, where: "Stronghold of Security — Sepulchre of Death", hunt: "Fourth floor. Not a Mort’ton shade.", wiki: rs3Wiki("Shade"), still: "" },
  { id: "rs3-skeleton", slug: "skeleton", name: "Skeleton", edition: "RS3", kind: "monster", slayer: true, where: "Stronghold of Security — Sepulchre of Death", hunt: "Fourth floor. Crush. Play the bar.", wiki: rs3Wiki("Skeleton"), still: "" },
];
