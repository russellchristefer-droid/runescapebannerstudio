...
export function godPageStyle(god: God): CSSProperties {
  const page = GOD_PAGE[god];
  const accent = GOD_NEON[god];
  return {
    "--god-page-bg": page.bg,
    "--god-page-well": page.well,
    "--god-page-fg": page.fg,
    "--god-page-muted": page.muted,
    "--god-page-accent": accent,
    "--god-page-line": accent,
  } as CSSProperties;
}
...
export const GOD_BRIEFS: Record<God, GodBrief> = {
  ...
  Sliske: {
    ...
    play: [
      ...
      "RuneScape fight: Rasial, Gregorovic. Old School has no Sliske raid.",
    ],
  ...
  Tumeken: {
    ...
    play: [
      ...
      "Old School fight: Tombs of Amascut, Kalphite Queen. RuneScape: Menaphos, Kalphite King.",
    ],
