...
export const CHANNELS: Channel[] = [
  ...
  { id: "sparcmac", name: "Sparc Mac", game: "osrs", twitch: "sparcmac", x: "SparcmacLive", era: "foundation" },
  { id: "woox", name: "Woox", game: "osrs", twitch: "wooxsolo", x: "WooxSolo", era: "foundation" },
  { id: "framed", name: "Framed", game: "osrs", twitch: "framed", era: "foundation" },
  { id: "b0aty", name: "B0aty", game: "osrs", twitch: "b0aty", x: "B0aty", era: "current" },
  ...
  { id: "gnomonkey", name: "Gnomonkey", game: "osrs", twitch: "gnomonkey", x: "GnomonkeyRS", era: "current" },
  { id: "westham", name: "Westham", game: "osrs", twitch: "westham", era: "current" },
  { id: "alfie", name: "Alfie", game: "osrs", twitch: "alfie", era: "current" },
  { id: "skillspecs", name: "Skill Specs", game: "osrs", twitch: "skillspecs", x: "skill_specs", era: "current" },
  ...
  { id: "coxie", name: "Coxie", game: "osrs", twitch: "coxie", x: "Coxie_rs", era: "current" },
  { id: "muts", name: "Muts", game: "osrs", twitch: "muts", era: "current" },
  { id: "soup", name: "Soup", game: "osrs", twitch: "soup", era: "current" },
  { id: "odablock", name: "Odablock", game: "osrs", twitch: "odablock", x: "Odablock", era: "current" },
  { id: "settled", name: "Settled", game: "osrs", twitch: "settled", x: "SettledRS", era: "current" },
  { id: "cengineer", name: "C Engineer", game: "osrs", twitch: "cengineer", x: "C_EngineerRS", era: "current" },
  ...
  { id: "ditter", name: "DitterBitter", game: "osrs", twitch: "ditterbitter", x: "DitterBitter", era: "current" },
  ...
  { id: "evscape", name: "EvScape", game: "rs3", twitch: "evscape", x: "EVScapeOfficial", era: "current" },
  { id: "itrolledu", name: "iTrolledU", game: "rs3", twitch: "itrolledu", x: "RSiTrolledU", era: "current" },
  ...
  { id: "willmissit", name: "RSWillMissIt", game: "rs3", twitch: "rswillmissit", x: "rswillmissit", era: "current" },
  ...
  { id: "torvesta", name: "Torvesta", game: "osrs", twitch: "torvesta", x: "Torvesta", era: "current" },
  { id: "afriend", name: "A Friend", game: "osrs", twitch: "afriend", x: "afriendrs", era: "current" },
  { id: "j1mmy", name: "J1mmy", game: "osrs", twitch: "j1mmy", x: "J1mmyRS", era: "current" },
  ...
  { id: "protoxx", name: "Protoxx", game: "rs3", twitch: "protoxx", x: "ProtoxxYT", era: "current" },
