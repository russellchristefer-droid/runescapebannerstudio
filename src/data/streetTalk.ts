...
const OSRS: Record<string, string[]> = {
  ...
  osrsape: [
    "Guard: greegree first. Marimbo’s island.",
    "Clerk: I do not sell a monkey.",
    "Porter: the boat is the rule. The city is later.",
    "Watch: speak ape or stay on the dock.",
    "Stall: bananas are work.",
    QUIET,
  ],
  osrsent: [
