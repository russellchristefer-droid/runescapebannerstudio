...
const OSRS: Record<string, string[]> = {
  osrslumbridge: [
    ...
    "Miller: the wheel turns. Goblins keep the east road. Count them, do not title them.",
    "Clerk: the Duke’s name is on the writ. I do not sell a later age.",
    "Fisher on the river: Lum still means the water. The castle is homework.",
    "Cook: the castle kitchen still burns the same stew. Burn it twice and you know the room.",
    "Guide: tutorial is a rumour. The bridge is the lesson. Walk it like you mean the bank.",
  ],
  osrsfalador: [
    "White Knight: walls hold. Kinshra are weather, not a timetable.",
    "Rising Sun keep: party room is still a room. Park is still a park. I do not print a hat.",
    "Guard: south gate to Port Sarim. North gate to the park. Pick one and walk it.",
    "Smith: the furnace is work. Honour is the report after the loot.",
    "Park warden: white walls, green lawn. Slapstick lives next door and pays rent.",
    "Knight on drill: polish is not piety. The gate still asks who you are.",
  ],
  osrsvarrock: [
    "Stallholder: east market first. Palace second. The square does not owe you a title.",
    "Guard: fountain square. Slums keep their own hours. Do not tour them with a max cape.",
    "Exchange runner: tax is public. This desk does not print a mid.",
    "Gertrude’s neighbour: the sill has a cat. Palaces inflate. Sit on the brick.",
    "Clerk: Roald’s name is on the writ. I sell bread. I do not sell a diary hour.",
    "Sewer grate: Scurrius lives under the city. Confirm the hole on the wiki before you boast.",
  ],
  hosidius: [
...
const RS3: Record<string, string[]> = {
  lumbridge: [
    "Watch: strangers still appear. The crater is part of the walk now. Name the age before you quote it.",
    "Sexton: the bell and the rim of the wound share a town. I do not sell a 2012 postcard.",
    "Guard: rebuild is polite. The meadow remembers otherwise.",
    "Clerk: I do not sell a 2012 title. The street is later and it still wants a bank.",
    "Miller: the wheel turns over a different map. Same flour. Different scar.",
    "Porter: castle first. The wound is geography, not a thumbnail.",
  ],
  falador: [
  ...
  varrock: [
    "Palace clerk: the crown speaks. The Exchange answers in numbers. Tax is public.",
    "South-east stall: unrest is weather. I do not sell it by the hour.",
    "Square runner: gossip is not my stock. Bread is.",
    "Guard: fountain and palace. Slums keep their own hours.",
    "Porter: the GE is a walk west. This brick is still Gertrude’s city.",
    "Clerk: I do not print a mid. Confirm the cut on the board.",
  ],
  prifddinas: [
