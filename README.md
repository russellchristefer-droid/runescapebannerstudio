...
Streamer and YouTuber halls list names even when live check is off. History has two rooms: Myths' Guild (Golden Gnome winners; the name opens the film) and Legends' Guild (first room on the left — Zezima, The Old Nite, 25 Buttholes, and the hiscores firsts). Public names only. Not a rank.
