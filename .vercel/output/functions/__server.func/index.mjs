...
var _lazy_RpxB79 = defineLazyEventHandler(() => import("./_routes/api/healthz.mjs"));
var _lazy_UMBjgo = defineLazyEventHandler(() => import("./_routes/api/hiscores.mjs"));
var _lazy_Ry3VIv = defineLazyEventHandler(() => import("./_routes/api/live.mjs"));
var _lazy_82U5cI = defineLazyEventHandler(() => import("./_routes/api/twitch_live.mjs"));
var _lazy_IO091Z = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const $0 = {
		route: "/api/healthz",
		method: "get",
		handler: _lazy_RpxB79
	}, $1 = {
		route: "/api/hiscores",
		method: "get",
		handler: _lazy_UMBjgo
	}, $2 = {
		route: "/api/live",
		method: "get",
		handler: _lazy_Ry3VIv
	}, $3 = {
		route: "/api/twitch-live",
		method: "get",
		handler: _lazy_82U5cI
	}, $4 = {
		route: "/**",
	...
	return (m, p) => {
		...
		} else if (p === "/api/hiscores") {
			if (m === "GET") return { data: $1 };
		} else if (p === "/api/live") {
			if (m === "GET") return { data: $2 };
		} else if (p === "/api/twitch-live") {
