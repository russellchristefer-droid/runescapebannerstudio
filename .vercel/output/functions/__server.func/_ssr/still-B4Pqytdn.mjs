...
import { T as useVisibleNow, _ as BackLink, g as EggToast, y as eggToast } from "./router-FfLcEMxQ.mjs";
import { i as stillPool, n as canUseOnDesk, r as heroCaption } from "./still-pool-CRylPt8Z.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/still-B4Pqytdn.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "One hosted photograph at a time from official wiki File pages. Classic, Old School, and RuneScape 3. Places and people. Same picture for everyone on the UTC five-minute mark. Identification only. Not a Jagex product."
					})
				]
			}),
