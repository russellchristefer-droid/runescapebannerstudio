...
//#region node_modules/.nitro/vite/services/ssr/assets/stream-desk-mBS9Cqpd.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: "This page does not go live for you. Encode in OBS or the official studio app. Capture the Jagex client window, not the desktop. Category is Old School RuneScape or RuneScape — never “RuneScape 3”. Cut a kill on the clip bench above, then use the notes below to title, size, and start the stream."
				})]
			}),
