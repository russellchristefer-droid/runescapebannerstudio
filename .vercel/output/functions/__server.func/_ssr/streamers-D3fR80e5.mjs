...
//#region node_modules/.nitro/vite/services/ssr/assets/streamers-D3fR80e5.js
...
function StreamersPage() {
	...
	const liveNow = livePeople.filter((row) => !row.official && match(row) && (cut === "all" || cut === "live" || row.game === cut)).sort((a, b) => a.name.localeCompare(b.name));
	const liveBadges = {};
