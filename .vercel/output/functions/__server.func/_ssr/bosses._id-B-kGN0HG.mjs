...
import { d as townPath, l as godInk, o as VisitPlaces, s as bossPath, u as godPath } from "./place-chip-CCVXVkdy.mjs";
import { t as PlaceRail } from "./place-rail-DFA15Tod.mjs";
import { t as townNote } from "./town-notes-gbQvMCvJ.mjs";
import { S as BackLink, a as Route$6, b as bossWipe, x as noteFor, y as bossWiki } from "./router-D8oIjQ4W.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/bosses._id-B-kGN0HG.js
var import_jsx_runtime = require_jsx_runtime();
function InventoryGrid({ items, note }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		...
		children: cells.map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			role: "listitem",
			title: item || "Empty",
...
function PrayerRow({ prayers }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
		className: "divide-y divide-line/40 rounded-md border border-line",
		children: prayers.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
			className: "grid grid-cols-[7.5rem_1fr] gap-3 px-3 py-2 text-sm md:grid-cols-[9rem_1fr]",
...
function FactRow({ header }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dl", {
		...
		children: rows.map(([k, v]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "grid grid-cols-[6.5rem_1fr] gap-3 px-3 py-2 text-sm md:grid-cols-[7.5rem_1fr]",
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Block, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: sheet.style
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
				title: "Sheet",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FactRow, { header: sheet.header })
			}),
			sheet.team?.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
				title: "Team",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
					className: "list-disc space-y-2 pl-5 text-sm text-muted",
					children: sheet.team.map((line) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: line }, line))
				})
			}) : null,
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
				title: "Opener",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
					className: "list-disc space-y-2 pl-5 text-sm text-muted",
					children: sheet.opener.map((line) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: line }, line))
				})
			}),
			sheet.osrs ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
					title: "Gear tiers",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tiers, { tiers: sheet.osrs.tiers })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
					title: "Inventory",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InventoryGrid, {
						items: sheet.osrs.inventory,
						note: sheet.osrs.inventoryNote
					})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
					title: "Food / brew / restore",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-muted",
						children: sheet.osrs.supplies
					})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
					title: "Prayer",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PrayerRow, { prayers: sheet.osrs.prayers })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Block, {
					title: "Tiles",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-muted",
						children: sheet.osrs.tiles
					}), sheet.osrs.stand?.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
						className: "mt-2 list-decimal space-y-1 pl-5 text-sm text-muted",
						children: sheet.osrs.stand.map((line) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: line.replace(/^\d+\s/, "") }, line))
					}) : null]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
					title: "Spec / thrall / death charge",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-muted",
						children: sheet.osrs.spec
					})
				}),
				sheet.osrs.sanity ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
					title: "Sanity",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-muted",
						children: sheet.osrs.sanity
					})
				}) : null,
				sheet.osrs.bank ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
					title: "Bank / trip",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-muted",
						children: sheet.osrs.bank
					})
				}) : null,
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
					title: "Skip",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-muted",
						children: sheet.osrs.skip
					})
				})
			] }) : null,
			sheet.rs3 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
					title: "Ability bar",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AbilityBar, {
						bar: sheet.rs3.bar,
						revolution: sheet.rs3.revolution
					})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
					title: "Camp / switch",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-muted",
						children: sheet.rs3.ultimates
					})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
					title: "Familiar / pocket / relic",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
						className: "list-disc space-y-2 pl-5 text-sm text-muted",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["Familiar — ", sheet.rs3.familiar] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["Pocket — ", sheet.rs3.pocket] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["Relic — ", sheet.rs3.relic] })
						]
					})
				}),
				sheet.rs3.enrage ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
					title: "Enrage / bank",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-muted",
						children: sheet.rs3.enrage
					})
				}) : null
			] }) : null,
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Block, {
...
var WIKI = "Confirm on the wiki.";
/** This-boss wiki on the other engine, only when the same fight exists there. */
var SISTER_WIKI = {
	vorkath: {
		label: "Vorkath · RuneScape wiki",
		href: "https://runescape.wiki/w/Vorkath"
	},
	corp: {
		label: "Corporeal Beast · RuneScape wiki",
		href: "https://runescape.wiki/w/Corporeal_Beast"
	},
	nex: {
		label: "Nex · RuneScape wiki",
		href: "https://runescape.wiki/w/Nex"
	},
	araxxor: {
		label: "Araxxor · OSRS wiki",
		href: "https://oldschool.runescape.wiki/w/Araxxor"
	},
	graardor: {
		label: "General Graardor · RuneScape wiki",
		href: "https://runescape.wiki/w/General_Graardor"
	},
	kree: {
		label: "Kree'arra · RuneScape wiki",
		href: "https://runescape.wiki/w/Kree%27arra"
	},
	kril: {
		label: "K'ril Tsutsaroth · RuneScape wiki",
		href: "https://runescape.wiki/w/K%27ril_Tsutsaroth"
	},
	zilyana: {
		label: "Commander Zilyana · RuneScape wiki",
		href: "https://runescape.wiki/w/Commander_Zilyana"
	},
	kq: {
		label: "Kalphite Queen · RuneScape wiki",
		href: "https://runescape.wiki/w/Kalphite_Queen"
	}
};
var UNOFFICIAL = {
	inferno: {
...
function unofficial(label, href, rank) {
	return {
		rank,
		label: `${label} · Unofficial`,
		href,
		unofficial: true
	};
}
/** At most three outbound links: this-boss wiki, sister-game wiki if the fight exists, one unofficial. */
function sourcesFor(note) {
	const out = [wikiSrc(note)];
	...
	if (extra && out.length < 3) out.push(unofficial(extra.label, extra.href, out.length === 1 ? 2 : 3));
	return out.slice(0, 3);
}
var OSRS_UNSAFE = "Unsafe. Confirm kept items on the wiki. Do not invent a gp number here.";
var RS3_GRAVE = "War's Retreat / gravestone reclaim. Confirm the cost on the wiki this hour.";
var HEADERS = {
	inferno: {
...
var TEAM = {
	...
	graardor: [
		"Tank — melee pray, hold the door side.",
		"Stack — the tile the mass uses.",
		"Hammer — if the pin listed specs."
	],
	kree: [
		"Tank — range pray.",
		"Stack — under or the mass tile.",
		"DPS — the style the pin listed."
	],
	kril: [
		"Tank — mage or melee as called.",
		"Stack — off the poison if the room uses it.",
		"DPS — the style the pin listed."
	],
	zilyana: [
		"Tank — mage pray.",
	...
	aod: [
		"Tank — the seat the pin named.",
		"North — one line.",
		"South — one line.",
		"DPS — tank is not a first-night seat."
	],
	solak: [
		"Tank — not a first-night seat.",
		"North / south — the called tile.",
		"DPS — the pin."
	],
	corp: [
		"Spear — if the small team uses spears.",
		"Mage — mass core.",
		"Caller — specs only if the mass uses them."
	],
	nightmare: [
		"Totem — charge, then the boss.",
		"Parasite — mage seat if the pin listed it.",
		"Stack — spores are a walk."
	],
	croesus: [
		"Wood — one node set.",
		"Mining — one node set.",
		"Hunter — one node set.",
		"Fishing — one node set."
	],
	bm: [
		"Pet — the pet the pin named.",
		"Charge — walk when called.",
		"DPS — the style the pin listed."
	],
	yaka: [
		"Stun — when the base says.",
		"Poison — the pool you were given.",
		"DPS — stun is not a first-night seat."
	],
...
function teamFor(note) {
	return TEAM[note.id];
}
function osrsTiers(id, note) {
	return {
		inferno: {
...
function osrsSupplies(id) {
	...
	}[id] ?? "Restores and food to finish the kill. Confirm counts on the wiki. Do not invent a number.";
}
function osrsSkip(id) {
	return {
	...
	}[id] ?? "Leave the style the room does not use home. Confirm the skip list on the wiki.";
}
function osrsBank(id) {
	return {
	...
	}[id] ?? "Bank when food or restores run out. Confirm the walk-back on the wiki.";
}
function osrsSanity(id) {
	return {
...
var SHEETS = {
	inferno: {
		...
		sources: [],
		osrs: {
			inventoryNote: "First-cape bag. Twisted bow or Bow of Faerdhinen is worn, not bagged. Wiki Strategies wins if a clip disagrees.",
			inventory: padInv([
				"Toxic blowpipe",
			...
			prayers: [
				{
					phase: "Waves 1–33",
					pray: "Protect Missiles. Rigour on. Priority mager > ranger > meleer > blob > bat."
				},
				{
					phase: "Waves 35–66",
					pray: "Protect Magic unless the spawn in your face is a ranger. Augury when you swap to mage."
				},
				{
					phase: "Triple Jad",
					pray: "The animation that is about to land. Sound first on mage. Delayed slam is range."
				},
				{
					phase: "Zuk",
					pray: "The shield is the prayer. Setters and Jad heals are the exam. No overhead stops Zuk."
				}
			],
			tiles: "North pillar to start. Trap behind a pillar; diagonal safespot on the south corner. Zuk: stay behind the shield, middle or a half-tile forward. Corners east and west are safespots when the shield parks. Mark with a vial if you must.",
			stand: [
	...
	tob: {
		...
		sources: [],
		osrs: {
			inventoryNote: "Learner void bag that can sit any seat. Worn: void melee helm, elite void, avernic or dragon defender, fire cape. Swap helms live.",
			inventory: padInv([
				"Scythe of vitur",
				"Sanguinesti staff",
				"Toxic blowpipe",
			...
			prayers: [
				...
				{
					phase: "Bloat",
					pray: "Protect Missiles. Walk the stomp; standing still is the wipe."
				},
				{
					phase: "Nylos",
					pray: "The style of the boss form. Pillars first."
				},
				{
					phase: "Sotetseg",
					pray: "The projectile colour. Maze is one caller."
				},
				{
					phase: "Xarpus",
					pray: "Protect Missiles when he is exposed. Redemption is a later seat."
				},
				{
					phase: "Verzik P1",
					pray: "Protect Magic. Crabs."
				},
				{
					phase: "Verzik P2",
					pray: "Protect Missiles. Leave the yellow pool."
				},
				{
					phase: "Verzik P3",
					pray: "The auto she is using. Tornadoes are a walk."
				}
			],
			tiles: "Maiden: crabs die on their side. A leak heals her. Bloat: walk during the stomp, do not plant. Nylos: hold a pillar. Sotetseg: the maze path the caller said — one wrong tile is a death. Xarpus: do not stand in poison splash. Verzik P2: step off yellow.",
			stand: [
	...
	toa: {
		...
		osrs: {
			...
			prayers: [
				{
					phase: "Akkha",
					pray: "The style he just used. Memory tiles first."
				},
				{
					phase: "Ba-Ba",
					pray: "Protect Melee. Boulder line."
				},
				{
					phase: "Kephri",
					pray: "Protect Magic. Dunk dung. Swarms down."
				},
				{
					phase: "Zebak",
					pray: "Missiles, then mage on the roar. Jugs on waves."
				},
				{
					phase: "Wardens",
					pray: "The skull he is charging. Walk the last slam."
				}
			],
			tiles: "Akkha memory: stand the tile the room painted. Baba: one boulder line. Kephri: dung goes in the scarab, not the floor. Zebak: jugs hit waves; acid is a walk. Wardens: charged skull is a leave.",
	...
	cox: {
		...
		osrs: {
			...
			prayers: [
				{
					phase: "Rooms",
					pray: "The style in that room. Call swaps."
				},
				{
					phase: "Olm melee claw",
					pray: "Protect Melee. Stay off the wrong claw."
				},
				{
					phase: "Olm mage claw",
					pray: "Protect Magic."
				...
				{
					phase: "Olm head",
					pray: "The style he is using. Last phase range the head."
				}
			],
	...
	vorkath: {
		...
		osrs: {
			...
			prayers: [
				{
					phase: "Grounded",
					pray: "Protect Missiles + Rigour. Walk the pink fireball."
				},
				{
					phase: "Acid",
					pray: "Same overhead. One straight line."
				},
				{
					phase: "Spawn",
					pray: "Crumble undead, then resume the six-count."
				}
			],
	...
	zulrah: {
		...
		osrs: {
			...
			prayers: [
				{
					phase: "Green",
					pray: "Protect Missiles. Range it."
				},
				{
					phase: "Red / blue",
					pray: "Protect Magic."
				...
				{
					phase: "Jad phase",
					pray: "The style that is about to land. Prayer first, click second."
				}
			],
	...
	nex: {
		...
		osrs: {
			...
			prayers: [
				{
					phase: "Smoke",
					pray: "Protect Magic. Clear minions. Walk the cough."
				},
				{
					phase: "Shadow",
					pray: "Protect Missiles. Stand off her line."
				},
				{
					phase: "Blood",
					pray: "Protect Magic. Do not sit the siphon."
				},
				{
					phase: "Ice",
					pray: "Protect Magic. Break icicles."
				},
				{
					phase: "Zaros",
					pray: "The style she is using."
				}
			],
	...
	hydra: {
		...
		osrs: {
			...
			prayers: [
				{
					phase: "Green / poison",
					pray: "Protect Magic. Walk the pool."
				},
				{
					phase: "Blue / lightning",
					pray: "Protect Missiles. Lightning is a leave."
				},
				{
					phase: "Red / fire",
					pray: "Protect Magic. Fire is a leave."
				},
				{
					phase: "Enrage",
					pray: "The style she just used. Keep swapping."
				}
			],
	...
	rasial: {
		...
		rs3: {
			...
			revolution: "Learners: a long revolution that fires the builders. Desk: short revolution, manual Skulls / Living Death / Volley. PvME lists tick waits — treat those as unofficial until the wiki agrees.",
	...
	telos: {
		...
		rs3: {
			...
			enrage: "Start 0%. Add 25% only after two clean kills. Bank at War's Retreat between enrage steps. 100% is the same rooms with less time. 200%+ one missed font is the kill.",
	...
	whisperer: {
		...
		osrs: {
			...
			prayers: [
				...
				{
					phase: "Silence tiles",
					pray: "Protect Magic. Walk. Do not plant."
				},
				{
					phase: "Enrage",
					pray: "Protect Magic. Tile test. Sanity first."
				}
			],
	...
	gauntlet: {
		...
		osrs: {
			...
			prayers: [{
				phase: "Hunllef",
				pray: "The style he is using. Swap on the animation."
			}, {
				phase: "Tornado",
				pray: "Same overhead. Walk."
			}],
	...
	raksha: {
		...
		opener: ["Anachronia. Poison pools have names before you chase a time.", "Pools: walk. Shadow: the tile. P4: do not channel into a beam."],
...
function fallbackOsrs(note) {
	const items = note.kit.join(", ").split(/[,.]/).map((s) => s.replace(/^(Learner|Desk):\s*/i, "").trim()).filter((s) => s.length > 3 && s.length < 42).slice(0, 12);
	return {
		inventoryNote: "Starter bag from this desk’s kit. Confirm names on the wiki page before you pull.",
		inventory: padInv([
			note.style.split(".")[0] ?? "Switch",
			...items,
			"Super restore",
			"Rune pouch",
			"Stamina potion"
...
function fallbackRs3(note) {
	if (note.id === "croesus") return {
		bar: [
			"Wood",
			"Mine",
			"Hunter",
	...
	return {
		...
		enrage: (/* @__PURE__ */ new Set([
			...
			"glacor",
			"araxxor"
		])).has(note.id) || note.role.toLowerCase().includes("enrage") ? "Start at 0%. Add enrage after two clean kills. Bank at War's Retreat between steps." : void 0,
...
function finishOsrs(note, draft) {
	if (!draft && note.edition !== "OSRS") return void 0;
...
function finishRs3(note, draft) {
	if (!draft && note.edition !== "RS3") return void 0;
...
function sheetFor(id) {
	...
	return {
		...
		sources,
		team,
		osrs: note.edition === "OSRS" ? fallbackOsrs(note) : void 0,
		rs3: note.edition === "RS3" ? fallbackRs3(note) : void 0
	};
}
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: sheet.sources.map((src) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
						href: src.href,
						target: "_blank",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-3",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PlaceRail, { section: "bosses" })
				})
			]
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BossSheet, { sheet }),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					...LOCATIONS.filter((row) => row.kind === "town" && row.god === loc.god && townNote(row.id)).slice(0, 6).map((row) => ({
						href: townPath(row.id),
						label: `${row.name}${row.edition === "OSRS" ? " · OSRS" : ""}`
					})),
					...LOCATIONS.filter((row) => row.kind === "boss" && row.edition === loc.edition && noteFor(row.id)).slice(0, 8).map((row) => ({
						href: bossPath(row.id),
						label: row.name,
						current: row.id === loc.id
					}))
				] })] }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UseOnBanner, {
					src: loc.viewA,
					edition: loc.edition,
					placeId: loc.id
				})
