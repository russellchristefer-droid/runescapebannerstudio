...
//#region node_modules/.nitro/vite/services/ssr/assets/official-pulse-Bm5wbKDQ.js
...
function OfficialPulse() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "page-band py-4",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "mb-1 text-sm font-semibold text-parchment",
				children: "Official notes"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mb-2 text-[10px] text-faint",
				children: "This desk does not write the patch. Official news wins."
			}),
