//#region node_modules/.nitro/vite/services/ssr/assets/boss-notes-BtB8wfDO.js
var BOSS_NOTES = {
	toa: {
		id: "toa",
		...
		method: ["Add one invocation rack only after a clean raid. A clean 50 teaches more than a wipe 200.", "One talker. Watch a VOD of your seat the night before. Time the raid, then cut one minute, not five."]
	},
	vorkath: {
		id: "vorkath",
		title: "Vorkath",
		...
		method: ["Woox walk is extra kills after pools are automatic. It is not hour one.", "A death on acid is a count error. Slow the next kill, then speed back up."]
	},
	tob: {
		id: "tob",
		...
		start: ["Entry mode until Maiden crabs are a call, not a surprise.", "One new seat per run. Wipe notes after the room, not mid-cast."],
		kit: ["Learner: hasta or whip, trident, blowpipe, avernic if you have it.", "Desk: scythe, tbow, sang, avernic, justiciar for Verzik tank if that is your seat."],
		route: [
		...
		method: ["A 4:30 Maiden does not save a 12-minute Verzik. Film your seat.", "Hard mode is a different exam. Do not add it to a first purple night."]
	},
	corp: {
		id: "corp",
		...
		start: ["Games necklace. Do not walk from the ditch with a spear out.", "If you are not on a spear, you are a core soak. Say that before the pull."],
		kit: ["Learner: hasta if you must, but a Zamorakian / dragon hunter lance is the ticket.", "Desk: crystal halberd specs, slayer helm if on task, divine super combat."],
		route: ["Stack the core. Do not leave a dark core on one person.", "Stomp: step out, then back in. Sigil drop is not a reason to stand in the middle."],
		method: ["Mass corp is a lottery. Spear teams are a job. Pick which night this is."]
	},
	nex: {
		id: "nex",
		title: "Nex",
		...
		start: ["Learn the four wings as a list: smoke, shadow, blood, ice, then zaros.", "Do not first-time as the person who has to tank a blood siphon."],
		kit: ["Learner: trident, blessed, a tank piece.", "Desk: ancestral, sang or shadow, tbow for shadow if the team uses it."],
		route: ["Smoke: clear minions, walk the cough. Shadow: stand off the line. Blood: do not sit the siphon. Ice: break icicles. Zaros: pray the auto."],
		method: ["A 5-man with a caller beats a 20-man with no plan. Watch one VOD per wing."]
	},
	zulrah: {
		id: "zulrah",
		title: "Zulrah",
		...
		start: ["Print or pin a rotation. First ten kills are the rotation, not the boss.", "Diary cape or scroll for the boat. Do not run from fairy ring every death."],
		kit: ["Learner: trident, blowpipe, void or ahrim / blessed swaps.", "Desk: ancestral, sang or shadow, tbow, toxic blowpipe for the green."],
		route: ["Stand the correct tile for that rotation. Jad: pray the first hit before you click.", "Snakelings: kill or ignore on the note you brought. Do not invent a third plan."],
	...
	inferno: {
		...
		start: ["Fight Caves first until Jad is boring. Inferno is not a first cape.", "Learn nibbler pathing in a dummy world or a guide that uses the same spawn set you will see."],
		kit: ["Learner cape attempt: bowfa or tbow, ancestral, sang, justiciar optional, 3–4 brews you can count.", "Desk: tbow, ancestral, lightbearer, the exact invos you practiced."],
		route: ["Waves: solve the stack, then the rest. Do not chip Zuk thinking.", "Jad: healers one at a time. Zuk: set, walk, Jad, healers, set again."],
	...
	nightmare: {
		...
		start: ["Mass first so you see every special without owning the room.", "Phosani is a different exam. Do not add it to a first night."],
		kit: ["Learner: hasta, blowpipe for totems.", "Desk: scythe, tbow, the parasite mage switch."],
		route: ["Spores: walk. Husks: pray. Totems: charge them, then the boss. Parasites: the person on that seat clicks them."],
		method: ["Small team Nightmare is a totem job. Mass is a prayer job. Say which one you are playing."]
	},
	graardor: {
		id: "graardor",
		...
		start: ["Kc first. Do not walk in with 5 kc and a scythe screenshot.", "Tank tile is a contract. Do not stand it unless you are the tank."],
		kit: ["Learner: bandos, hasta, super combats.", "Desk: scythe, inquisitor if you own it, blood fury."],
		route: ["Minions then boss, or the order the tank called. Do not invent a third order."],
		method: ["A trip is kc plus a door. Loot talk happens after the last kill."]
	},
	kree: {
		id: "kree",
		title: "Kree'arra",
	...
	muspah: {
		...
		start: ["Ghorrock after DT2. Learn the three forms as a list before you chase a time."],
		kit: ["Learner: bowfa, trident, a melee swap.", "Desk: tbow, shadow or sang, scythe on the last form if that is your note."],
	...
	hydra: {
		...
		start: ["Konar or slayer task. Do not first-time off-task if you care about the claw."],
	...
	telos: {
		...
		start: ["0–100% until fonts and anima are boring. Do not jump to 200 because a VOD did.", "War's Retreat. One preset. One familiar. Write the enrage on the screen."],
		kit: ["Learner: best necro or mage you own, vuln bomb, a stun.", "Desk: the PvME page for this hour. Do not mix three discords."],
		route: [
		...
		method: ["Add 25% only after two clean kills. A wipe streak is a note problem, not an RNG problem."]
	},
	raksha: {
		id: "raksha",
		title: "Raksha",
		...
		start: ["Anachronia. Learn the poison pools before you chase a time."],
		kit: ["Learner: best mage, poison purge if you use it.", "Desk: PvME necro or mage page."],
		route: ["Pools: walk. Shadow: the tile. P4: do not greed a channel into a beam."],
	...
	vorago: {
		...
		start: ["Week rotation is public. Read it before you type 'inv'.", "Do not first-time as base. Watch a VOD of this week's mechanic."],
		kit: ["What the lead pinned. No surprise scythe if they asked for a bomb."],
		route: ["P5 bleed: stack only on the called tile. One talker. Extra voice on bomb is a wipe."],
		method: ["Show up on time with the week note open. Gear flex is not a role."]
	},
	solak: {
		id: "solak",
		title: "Solak",
		...
		kit: ["Team sheet first. Your best melee unless the lead parked you on core."],
	...
	glacor: {
		...
		route: ["The mechanic you ticked is the fight. Do not tick five on a first night."],
		method: ["Streaks pay. A wipe on mechanic three is a note you did not read."]
	},
	rasial: {
		id: "rasial",
		title: "Rasial",
		...
		start: ["City of Um. Learn the conjure cycle before you chase a time."],
		kit: ["Best necro. The PvME Rasial page for this hour."],
		route: ["Conjures up. Volley walk. Do not drop a living death window on a special."],
	...
	kerapac: {
		...
		start: ["Anachronia lab. Learn the time-stop walk before 100% enrage."],
	...
	qbd: {
		...
		route: ["Click artifacts on the call you practiced. Walk the fire walls. Kill the coffins if they are up."],
	...
	cox: {
		...
		start: ["Learn one layout. Do not first-time Olm in a 15-man.", "Points come from rooms, not only the head."],
		kit: ["Learner: hasta, trident, blowpipe, dwh or bgs.", "Desk: scythe, shadow or sang, tbow, elder maul."],
		route: ["Clear rooms clean. Olm: spec the mage claw, melee the left, range the head when he stands.", "Do not tank a teleport crystal in the middle of the room."],
	...
	whisperer: {
		...
		start: ["Sanity food and a plan for the corridor. Do not first-time enrage."],
	...
	leviathan: {
		...
		start: ["Learn the path around the arena before you chase a time."],
	...
	gauntlet: {
		...
		start: ["Perfected weapons and armour before the door. Corrupted is a different exam."],
		kit: ["What you built. Do not enter under-geared on purpose."],
	...
	scurrius: {
		...
		start: ["Varrock sewers. Bring food you can afford to lose."],
		kit: ["Whatever you train with. Do not buy a scythe for this."],
	...
	ambassador: {
		...
		start: ["Learn the black hole walk before you chase enrage."],
	...
	croesus: {
		...
		kit: ["Skilling outfit and the tool the role needs. No scythe."],
		route: ["Call the fungus. Do not stack four people on one node."],
	...
	aod: {
		...
		kit: ["What the lead listed. Do not bring a flex piece they did not call."],
		route: ["Elements in order. Minions on the call. One talker."],
		method: ["Show up on time with the week note. Gear flex is not a role."]
	},
	kk: {
		id: "kk",
		title: "Kalphite King",
		...
		start: ["Swap when he changes colour. Do not camp one style."],
	...
	sanctum: {
		...
		start: ["Learn the wing you were given. Do not first-time every wing in one night."],
	...
	yaka: {
		...
		start: ["Do not first-time Yaka the same night as first Durzag."],
		kit: ["Raid sheet."],
...
//#endregion
export { noteFor as n, BOSS_NOTES as t };
