//#region node_modules/.nitro/vite/services/ssr/assets/studio-save-BZUmR0QZ.js
var CTRL = /[\u0000-\u0008\u000b\u000c\u000e-\u001f\u200b-\u200f]/g;
...
function loadStudioSave() {
	try {
		...
		const picks = stale ? void 0 : Array.isArray(data.skillPicks) ? data.skillPicks.slice(0, 12).map((row) => ({
