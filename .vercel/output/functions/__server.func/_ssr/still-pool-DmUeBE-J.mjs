//#region node_modules/.nitro/vite/services/ssr/assets/still-pool-DmUeBE-J.js
var HERO_STILLS = [
	{
...
function canUseOnDesk(card) {
	return card.kind === "place" && (card.era === "osrs" || card.era === "rs3") && Boolean(card.placeId);
}
//#endregion
export { stillPool as i, canUseOnDesk as n, heroCaption as r, HERO_STILLS as t };
