//#region node_modules/.nitro/vite/services/ssr/assets/store-pWHXaoAo.js
var CTRL = /[\u0000-\u0008\u000b\u000c\u000e-\u001f\u200b-\u200f]/g;
...
function loadStudioSave() {
	try {
		...
		return {
			...
			stillSrc: /^\/(?!\/)[A-Za-z0-9_./-]+\.(png|jpe?g|webp)(\?.*)?$/i.test(data.stillSrc ?? "") ? clip(data.stillSrc, 180) : void 0,
...
//#endregion
export { writeStudioSave as i, putStillOnDesk as n, readDesk as r, loadStudioSave as t };
