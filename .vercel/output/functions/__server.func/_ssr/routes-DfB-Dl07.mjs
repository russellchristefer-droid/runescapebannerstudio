...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DfB-Dl07.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var Studio = (0, import_react.lazy)(() => import("./studio-JXQl-sSq.mjs").then((mod) => ({ default: mod.Studio })));
function Home() {
