...
import { t as loadStudioSave } from "./studio-save-1SaG6gyq.mjs";
import { v as SiteHeader } from "./router-FfLcEMxQ.mjs";
import { a as sanitizeDisplayName, d as worldLabel, r as sanitizeClan, u as sanitizeWorld } from "./rsText-CBarotbs.mjs";
import { n as drawSafeZoneGhosts } from "./bannerFeatures-C-gzeYX5.mjs";
import { t as StreamDesk } from "./stream-desk-mBS9Cqpd.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/edit-B9GVOxOo.js
...
function ClipBench() {
	...
	const [titleOn, setTitleOn] = (0, import_react.useState)(false);
	...
	function markIn() {
		pushUndo();
		const [a, b] = orderInOut(snapOn ? Math.round(now) : snapTime(now, fps), outPoint);
		setInPoint(a);
		setOutPoint(b);
	}
	function markOut() {
	...
	function splitAtPlayhead() {
		pushUndo();
		const t = snapOn ? Math.round(now) : snapTime(now, fps);
		if (t - inPoint <= outPoint - t) setInPoint(Math.min(t, outPoint - .05));
		else setOutPoint(Math.max(t, inPoint + .05));
	}
	function deleteRegion() {
		pushUndo();
		if (now - inPoint < outPoint - now) setInPoint(Math.min(outPoint - .05, snapOn ? Math.round(now) : now));
		else setOutPoint(Math.max(inPoint + .05, snapOn ? Math.round(now) : now));
	}
	function undo() {
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					className: hasClip ? "min-h-12 min-w-12 rounded-md border border-[#c6a45a] bg-[#9b1b1b] px-5 text-sm font-semibold text-[#efe0c4] hover:bg-[#b42323] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#c6a45a] disabled:opacity-40" : "min-h-12 min-w-12 rounded-md border border-[#3a3228] bg-[#2a241c] px-5 text-sm text-faint",
					onClick: () => {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							disabled: !hasClip,
							className: "h-9 rounded-md border border-line px-2 text-[10px] text-muted disabled:opacity-40",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: `h-9 rounded-md border px-2 text-[10px] ${snapOn ? "border-parchment" : "border-line"}`,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: "h-9 rounded-md border border-line px-2 text-[10px] text-muted",
							onClick: () => setZoom((v) => Math.min(2, v + .1)),
							children: "Scale +"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: `h-9 rounded-md border px-2 text-[10px] ${muted ? "border-parchment" : "border-line"}`,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: "h-9 rounded-md border border-line px-2 text-[10px] text-muted",
							onClick: () => {
								setFadeIn(Math.round(fps * .5));
								setFadeOut(Math.round(fps * .5));
							},
							children: "Fade 0.5s"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: `h-9 rounded-md border px-2 text-[10px] ${titleOn ? "border-parchment" : "border-line"}`,
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ol", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Mark in and out." }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Save the file. Pete does not work here." })
					]
				}),
