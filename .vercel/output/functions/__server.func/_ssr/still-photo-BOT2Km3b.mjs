...
//#region node_modules/.nitro/vite/services/ssr/assets/still-photo-BOT2Km3b.js
var import_jsx_runtime = require_jsx_runtime();
function StillPhoto({ src, alt, priority = false, className = "aspect-video w-full bg-surface object-cover", onError }) {
