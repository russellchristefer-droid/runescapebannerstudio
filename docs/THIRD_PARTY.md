...
- Jagex Limited — RuneScape®, Old School RuneScape®, RuneScape Classic, RuneScape: Dragonwilds™, Jagex® marks, stills, skill icons. Not licensed to this studio beyond Fan Content Policy identification.
- Official wikis — article text often CC BY-NC-SA; **files** stay Jagex copyright. File pages in `src/lib/stills-provenance.ts`.
- RuneLite — third-party Old School RuneScape® client, BSD-2-Clause. Sidecar plugins are not Plugin Hub.
- Alt1 Toolkit — skillbert / runeapps.org. Sidecar apps are fan add-ons.
